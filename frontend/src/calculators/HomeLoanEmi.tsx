    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <section className="pt-32 pb-20 bg-gradient-to-r from-blue-600 to-green-600 text-white relative overflow-hidden">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold mb-6">Home Loan EMI Calculator</h1>
            <p className="text-xl mb-8 max-w-3xl">
              Calculate your monthly EMI for a home loan based on the loan amount, interest rate, and tenure.
            </p>
          </motion.div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
              <div className="p-6 md:p-10">
                <h2 className="text-2xl font-bold text-gray-800 mb-4">Calculate Your Home Loan EMI</h2>
                ...
                {emiAmount !== null && (
                  <div className="mt-6 p-4 bg-blue-100 rounded-md">
                    ...
                    <p className="text-sm text-gray-600">
                      This is the monthly EMI you would need to pay for your home loan based on the entered loan amount, interest rate, and tenure.
                    </p>
                  </div>
                )}
              </div>
