      ...
      <main className="flex-grow">
        <section className="py-20 bg-gradient-to-b from-purple-900 to-purple-800 text-white">
          <div className="container mx-auto px-4">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">FinPulse Blog</h1>
            <p className="text-xl mb-8">Insights, analysis, and expert opinions on all things finance.</p>
